            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="pull-right box-tools impbtntitle">
                        <?php if ($this->rbac->hasPrivilege('import_student', 'can_view')) { ?>
                            <a href="<?php echo site_url('student/import') ?>">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-upload"></i>
                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>" id="employeeform"
                        ...
                        <div class="">
                            <div class="bozero">
                                <h4 class="pagetitleh-whitebg"><?php echo $this->lang->line('student'); ?>
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputEmail1"><?php echo $this->lang->line('course'); ?></label><small
                                                    class="req"> *</small>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="section_id" name="section_id" class="form-control">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php 
                                                    $getSession = $this->db->query("SELECT * FROM sessions ")->result_array();
                                                    if(!empty($getSession)) {
                                                        foreach ($getSession as $session) {
                                                        if($this->setting_model->getCurrentSessionName() == $session['session']) { ?>
                                                        <option value="<?= $session['id']?>" selected><?= $session['session']?></option>
                                                        <?php } else { ?>
                                                        <option value="<?= $session['id']?>"><?= $session['session']?></option>
                                                    <?php } } } else {?> 
                                                    <option value=""><?php echo $this->lang->line('no_session_found'); ?></option>
                                                    <?php } ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        if ($sch_setting->student_photo) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label
                                                        for="exampleInputFile"><?php echo $this->lang->line('student_photo'); ?></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 pt25">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <button type="button" class="btn btn-sm mysiblings anchorbtn "><i
                                                            class="fa fa-plus"></i>
                                                        <?php echo $this->lang->line('add_sibling'); ?></button>
                                                </div>
                                                <div class="col-md-7">
                                                    <div id='sibling_id' class="pt6"> <span id="sibling_name"
                                                                    ...
                                                                    <div class="panel panel-default1">
                                                                        <div class="panel-heading pt5 pb5">
                                                                            <h6
                                                                                ...
                                                                                <span
                                                                                    class="float-right bmedium pt3 fee_group_total"
                                                                        ...
                                                                        <div id="collapse_fees_<?php echo $feesessiongroup_value->id ?>"
                                                                            ...
                                                                            <ul class="list-group student_fee_list ui-sortable">
                                                                                <li class="list-group-item">
                                                                                    <div
                                                                                        class="displayinline stfirstdiv bmedium font14 pl-65">
