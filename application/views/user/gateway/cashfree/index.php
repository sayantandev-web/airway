                ...
                echo $fees_value['fee_type_code'];
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <input type="text" class="form-control" name="email" value="<?php echo set_value('email', $student_data['guardian_email']); ?>"><span class="alert-danger "> <?php echo form_error('email'); ?></span></td>
                                        </tr>
                                        <hr> 
                                        <tr class="bordertoplightgray">
