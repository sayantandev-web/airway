                ...
                echo $fees_value['fee_type_code'];
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <input type="password" class="form-control"  name="password" value="<?php echo set_value('password'); ?>" /></td>
                                        </tr>
                                        <?php 
                                        if((!empty(validation_errors())) || ($api_error!='')){
                                           ?>
                                           <tr class="bordertoplightgray">
                                            <td  bgcolor="#fff" colspan="2"><div class="alert alert-danger"><?php echo validation_errors(); if(!empty($api_error)){ print_r($api_error); }?></div></td>                                            
                                        </tr>
                                           <?php 
                                        }
                                        ?>                                        
