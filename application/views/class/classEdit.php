...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            if ($this->rbac->hasPrivilege('class', 'can_add') || $this->rbac->hasPrivilege('class', 'can_edit')) { echo "8"; } else { echo "12"; } ?>  ">
                <div class="box box-primary">
                                    ...
                                    <?php foreach ($vehroutelist as $vehroute) { ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                <a href="<?php echo base_url(); ?>classes/delete/<?php echo $vehroute->id; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('deleting_course'); ?>');">
